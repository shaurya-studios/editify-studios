    ...
    <main className="relative w-full min-h-[200vh]" ref={containerRef}>
      ...
      <section id="pricing" className="w-full px-5 md:px-10 py-32 z-10 relative border-t border-zinc-200 dark:border-zinc-900/50">
        <div className="max-w-[2000px] mx-auto">
          ...
          {/* Bulk Orders Note */}
          <Magnetic className="w-full block mt-10">
            <a href="https://discord.gg/JMhA5PERdS" target="_blank" rel="noreferrer" className="grid-item p-8 rounded-[2rem] border border-zinc-200/50 bg-white/30 dark:border-zinc-800/50 dark:bg-zinc-950/30 backdrop-blur-sm flex flex-col items-center justify-center text-center hover:border-yellow-600/30 hover:bg-yellow-600/5 dark:hover:bg-yellow-500/5 transition-all duration-500 cursor-pointer w-full">
